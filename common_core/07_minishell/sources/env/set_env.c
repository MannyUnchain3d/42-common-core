...
/*   Updated: 2023/06/24 20:45:35 by Manny            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

/* Reallocates memory for new environment variables and copies the old ones.
 * Returns a pointer to the new env vars or NULL if ft_calloc fails */
 ...
 * Overwrite any existing key or creates a new one.

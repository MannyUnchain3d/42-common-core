...
/*   Updated: 2023/07/21 06:23:23 by Manny            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap(void) :
	ClapTrap("Default"), _fragHp(100), _fragHpMax(100), _fragEp(100), _fragAd(30) {
...
FragTrap::FragTrap(std::string name) :
	ClapTrap(name), _fragHp(100), _fragHpMax(100), _fragEp(100), _fragAd(30) {
	this->_hp = this->_fragHp;
	this->_hpMax = this->_fragHpMax;
	this->_ep = this->_fragEp;
	this->_ad = this->_fragAd;
